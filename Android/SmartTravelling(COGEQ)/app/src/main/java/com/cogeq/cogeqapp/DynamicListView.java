...
public class DynamicListView extends ListView {
    ...
    public ArrayList<CogeqActivity> mCheeseList;
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        CogeqActivityAdapter adapter = ((CogeqActivityAdapter)getAdapter());
    ...
    public void setCheeseList(ArrayList<CogeqActivity> cheeseList) {
